 ...
 /* Original code: https://github.com/bruhautomation/ESP-MQTT-JSON-Digital-LEDs
    Přidána podpora PIR senzoru, který MQTT Brokeru odesílá aktuální stav senzoru
*/
...
#define SENSORNAME "pds"




/************* MQTT TOPICS (change these topics as you wish)  **************************/
const char* light_state_topic = "pds/led";
const char* light_set_topic = "pds/led/set";
const char* pir_state_topic = "pds/pir";

const char* on_pir = "Motion detect";
const char* off_pir = "StandBy";
const char* actual_pir = "StandBy";
const char* send_pir = "Send notification";
...
void detectMovement() {
  ...
  if (digitalRead(GPIO_NUM_4) == HIGH)
  {
    if (now > (lastSend + minSecsBetweenEmails * 1000l))
    {
     // Serial.println("Movement detected. \n Notification send...");
      ...
      root["motion"] = send_pir;
      lastSend = now;

    }
    else {
      root["motion"] = on_pir;
      //Serial.print("Movement detected. \n Notification wasn't sent. \n Time to the next notification: ");
     double estTime = now-( lastSend + minSecsBetweenEmails);
      //Serial.println(estTime,5);
  ...
  root.printTo(Serial);
  Serial.println("");
  client.publish(pir_state_topic, buffer, true);
}
